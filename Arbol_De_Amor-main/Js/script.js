...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para el amor de mi vida:\n\nHola amorcito mio, sé que ya estas durmiendo pero espero que esto te provoque una sonrisita por la mañana.\n\nPor nada en el mundo olvides lo mucho que te amo mi niña preciosa.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Jorge García";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-04-17T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-04-17T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos siendo novios: <b>${days}</b> días<br>` +
      `Nuestro primer año: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
